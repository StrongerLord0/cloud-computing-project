...
export default function About() {
    ...
    const formattedMonthYear = capitalizeFirstLetter(monthYear.trim());

    const formattedFinalDate = `${formattedDay}, ${date} de ${formattedMonthYear}`;

    const transformEmotionsData = (data) => {
        const translations = {
            angry: 'Enojo',
            disgust: 'Disgusto',
            fear: 'Miedo',
        ...
        >
            ...
            >
                ...
                <div className="flex w-2/3 h-full flex-col text-center text-white items-center">
                    <div className="text-xl w-3/4 text-left font-extralight mb-2">{formattedFinalDate}</div>
                    <div className="text-2xl w-3/4 text-left justifyfont-bold mb-2">ULTIMAS PUBLICACIONES</div>
                    <div className="flex w-5/6 h-full flex-col overflow-y-auto items-center text-center">
                        {!tweets || tweets.length === 0 ? (
                            <div role="status" className='h-3/4 justify-center flex items-center'>
                            ...
                            <AnimatePresence>
                                {tweets.map((tweet, index) => (
                                    ...
                                    >
                                        <div index={index} className="bg-white dark:bg-gray-800 border-gray-200 dark:border-gray-800 p-4 rounded-xl border min-w-[600px] max-w-xl w-full">
                                            <div className="flex justify-between w-full">
                                                ...
                                                <div className="flex h-10 text-white">
                                                    <svg className="dark:text-white text-white fill-current" viewBox="0 0 24 24">
                                                        <g>
